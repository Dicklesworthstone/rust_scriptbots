...
| `fastmcp-rust` 0.9.0 | direct (`scriptbots-app`) | git rev `180a7c88890705217bb8e202d19555adabf24187` | MIT + Rider (verified at pin) | native control surface | Dependency migration preserves the existing HTTP protocol adapter; native validation pending. |
