...
- `HostCore` applies commands and advances science. Its fixed-deadline driver handles wakeups and bounded catch-up, while ordered shutdown waits for the required journal commitment. The broader frontend acceptance work remains open under `bd-pcfj`; browser ownership is a separate path.
